...
function footerAnimation(){
    var clutter = ""
var clutter2 = ""
document.querySelector(".footer h1").textContent.split("").
...
document.querySelector(".footer h2").textContent.split("").
forEach(function(elem){
